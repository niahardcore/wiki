...
```shell
"C:\Program Files\1cv8\8.3.23.2040\bin\ibcmd.exe" infobase dump --db-server="localhost\SQLExpress" --dbms=MSSQLServer --db-user=sa --db-pwd=qwerty@2 —db-name="monitor" --user="Хорошие люди" --password="iddqdidkfa" "D:\Backup1C\monitor.dt"
```
